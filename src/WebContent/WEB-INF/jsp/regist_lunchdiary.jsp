...
<!-------------------- ランチ日記登録フォーム -------------------------->
<table>
<form method="POST" action="/lunchBox/RegistLunchServlet"enctype="multipart/form-data" id = registLdForm>
<div id="displayBox">
	<div class="cm_box active">
		...
		<!-- 登録ボタン -->
		<input type="submit" name="registNewAccount" value="登録する" class = "submitBtn" form = "registLdForm"><br>
	</div>
</div>
</body>
</html>