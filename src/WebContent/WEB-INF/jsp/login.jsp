...
<body>
	...
	<form method="POST" action="/lunchBox/LoginServlet">
		  <p>
	        <input type="text" name="emailAddress" placeholder="Email Address" value= "${emailAddress}" required>
	      </p>
	      <p>
	        <input type="password" name="pw" placeholder="Password" id="pw" required>
	      </p>
	      <p>
